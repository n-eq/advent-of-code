...
fn get_map(input: &str) -> Vec<GardenPlot> {
...
fn solve(filename: &str) -> (usize, usize) {
    let map: Vec<GardenPlot> = get_map(filename);
...
mod tests {
    #[test]
    fn example_input() {
        assert_eq!(crate::solve("input_test"), (140, 80));
    }

    #[test]
    fn large_input() {
        assert_eq!(crate::solve("large"), (1930, 1206));
    }
}
